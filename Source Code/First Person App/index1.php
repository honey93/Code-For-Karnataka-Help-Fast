<html><head>
    ...
    <script>
      function loluqw()
                    		{
                    		alert("Message has been conveyed, Life Support System is on the way");
                    		}
                                var map;
                                        ...
                                        query.get("Y6aUedOohl", {
                                          ...
                                          document.getElementById("cus").innerHTML = "Police Man Contact-  " + " " + u_name;
                                         document.getElementById("cus_no").innerHTML = "Ambulance Contact-  " + " " + u_phone;
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-3">
            ...
            <h3 id="cus">Police Man Contact No:-</h3>
            <h3 id="cus_no">Ambulance Contact No:-</h3>
            <button class="btn btn-block btn-danger btn-lg" onclick="loluqw()">High Emergency</button>
            <a class="btn btn-block btn-lg btn-primary" href="index.html">Go to Dashboard</a>
          </div>
        </div>
      </div>
    </div>
    <footer class="section section-primary">
      <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <h3 class="text-left">Code for Karnataka</h3>
