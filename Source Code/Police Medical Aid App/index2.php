<html><head>
    ...
    <link rel="stylesheet" href="Delivery_boy.css">
    ...
    <script>
      var map;
                    		...
                    		function initialize() {
                    	//	var name = localStorage.getItem('user_name_autq');
                    		//var no_name = localStorage.getItem('rollno_userq');
                    ...
                    var na = localStorage.getItem('user_name_autq');
                       var mmnna = localStorage.getItem('rollno_userq'); 
                    ...
                    query.get("BzVL57LOEx", {
                     ...
                     // alert("hi");
                      ...
                      document.getElementById("cus").innerHTML = "First Person Name-  " + " " + u_name;
                     document.getElementById("cus_no").innerHTML = "First Person Phone NO-  " + " " + u_phone;
                     document.getElementById("pas_no").innerHTML = "FIR-  " + " " + no_pass;
                    ...
                    var asd = new google.maps.LatLng(lati_q,longi_q);
                    	...
                    	if(rt == 0)
                    	{
                    	  ...
                    	  markera = new google.maps.Marker({position:asd,map:map,title:"Driver",icon: 'car.png'});
                    ...
                    // query.get("BzVL57LOEx", {
                      ...
                      // var u_phone = gameScore.get("user_phone");
                      // document.getElementById("cus").innerHTML = "Customer Name-  " + " " + u_name;
                     // document.getElementById("cus_no").innerHTML = "Phone NO-  " + " " + u_phone;
                    ...
                    // alert(longi_q);
                      ...
                      // pqr = new google.maps.LatLng(lati_q, longi_q)
                    	...
                    	// lonq = longi;
                    // alert(latq);
                        // asd = new google.maps.LatLng(lat, lon)
                        ...
                        // var marker = new google.maps.Marker({position:asd,map:map,title:"Delivery Boy"});
                    
                    	// var marker_1 = new google.maps.Marker({position:pqr,map:map,title:"customer"});
                    	// }
    ...
    <div class="section">
      <div class="container">
        <h2 class="text-center text-danger">Police/Medical Application</h2>
        <div class="row">
          <div class="col-md-9">
          ...
          <div class="col-md-3">
            ...
            <h3 id="cus">First Person Name:-</h3>
            <h3 id="cus_no">First Person Contact No:-</h3>
            <h3 id="pas_no">FIR(Report):-</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <a class="btn btn-block btn-primary" href="index.html">Go to Dashboard</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Welcome Delivery Boy to delivery applicaation</h4>
          </div>
          <div class="modal-body">
            ...
            <form role="form" name="myForm" onsubmit="return validateForm()">
              ...
              <div class="form-group">
                ...
                <input class="form-control" name="rollll" id="exampleInputEmail1" placeholder="Enter Phone NO">
              </div>
